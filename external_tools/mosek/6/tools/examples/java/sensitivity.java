    ...
    public static void main (String[] args)
    {
        ...
        {                
            ...
            mosek.Env.boundkey[] bkc =
                { mosek.Env.boundkey.up, mosek.Env.boundkey.up,
                  mosek.Env.boundkey.up, mosek.Env.boundkey.fx,
                  mosek.Env.boundkey.fx, mosek.Env.boundkey.fx,
            ...
            int subi[]  = {0,3};         
            mosek.Env.mark marki[] = {mosek.Env.mark.up,mosek.Env.mark.up};

            /* Analyze lower bound on the variables x12 and x31 */ 
            int subj[]  = {1,4};
            mosek.Env.mark markj[] = {mosek.Env.mark.lo,mosek.Env.mark.lo};
