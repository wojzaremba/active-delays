...
/* Microsoft solver foundation example which load an MPS file
   and solve the problem using mosek interior point */
  ...
  class Program {
    static void Main(string[] args) {

      {
        ...
        {
            Console.WriteLine("Usage: MSFMosekPluginEx1 filename");
        }
      }  
    } 
  }
